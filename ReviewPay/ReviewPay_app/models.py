...
class UserDetail(models.Model):
    ...
    profile_image_color = models.CharField(max_length=255)
    class Meta:
...
class BusinessVerifications(models.Model):
    ...
    monday_from = models.CharField(max_length=255)
    monday_to = models.CharField(max_length=255)
    tuesday_from = models.CharField(max_length=255)
    tuesday_to = models.CharField(max_length=255)
    wednesday_from = models.CharField(max_length=255)
    wednesday_to = models.CharField(max_length=255)
    thursday_from = models.CharField(max_length=255)
    thursday_to = models.CharField(max_length=255)
    friday_from = models.CharField(max_length=255)
    friday_to = models.CharField(max_length=255)
    saturday_from = models.CharField(max_length=255)
    saturday_to = models.CharField(max_length=255)
    sunday_from = models.CharField(max_length=255)
    sunday_to = models.CharField(max_length=255)
    monday_from = models.CharField(max_length=255)
